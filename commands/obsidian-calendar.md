...
triggers_de: ["meine Agenda durchgehen", "meinen Kalender prüfen", "was steht in meinem Kalender", "was steht diese Woche an", "Agenda für diese Woche", "Kalender abgleichen", "was fehlt in meinem Kalender", "habe ich etwas im Kalender übersehen", "eine Besprechungsnotiz erstellen", "dieses Meeting festhalten", "Notiz für dieses Meeting", "dieses Meeting vorbereiten", "ein Meeting planen", "einen Termin buchen", "in meinen Kalender eintragen", "diese Aufgabe terminieren", "einen passenden Zeitpunkt finden"]
